...
public class Payments {
	...
	public Connection connect()
	{
	 ...
	 try
	 {
		 ...
		 con= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/pay", "root", "#thilu12");
	 }
	 catch(Exception e)
	 {
		 e.printStackTrace();
...
//				 + "'>" + phone + "</td>"; 
	...
	//Insert function
	public String insertPay(String payID, String cusN, String pmethod, String date, String amount)
	{
	 String output = "";
	 try
	 {
	 ...
	 // Prepared statement
	 String query = " insert into payments(`noticeId`,`payID`,`cusN`,`pmethod`, `date`, `amount`)" + " values (?, ?, ?, ?,?,?)";
	 PreparedStatement preparedStmt = con.prepareStatement(query);
	 
	 // Binding values
	 preparedStmt.setInt(1, 0);
	 preparedStmt.setString(2, payID);
	 preparedStmt.setString(3, cusN);
	...
	//Update function
	public String updatePay(String noticeId, String payID, String cusN, String pmethod, String date, String amount) 
	{
			 String output = "";
			 try
			 {
			 ...
			 String query = "update payments set payID=?, cusN=?, pmethod=?, date=?, amount=? where noticeId=?";
			 PreparedStatement preparedStmt = con.prepareStatement(query);
			 
			 // Binding values
			 preparedStmt.setString(1, payID);
			 preparedStmt.setString(2, cusN);
